...
public class Water extends Actor
{
    ...
    public DefensiveObject getRandomNearDijk(){
        List<Dijk> nearDijk = getObjectsInRange(27, DefensiveObject.class);
        Random rand = new Random(); 
        if(nearDijk.size() > 0){
    ...
    public List<DefensiveObject> getRandomNearDijks(){
        List<DefensiveObject> nearDijk = getObjectsInRange(23, DefensiveObject.class);
        if(nearDijk.size() > 0){
            return nearDijk;
        }
        else {
